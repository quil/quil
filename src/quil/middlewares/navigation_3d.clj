...
(defn- rotate-by-axis-and-angle [v axis angle]
...
(defn- rotate [state event pixels-in-360]
...
(defn- move [state event step-size]
...
(defn- setup-3d-nav [user-setup user-settings]
